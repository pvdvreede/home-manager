{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-1a0b379e-262c-45b4-8b4e-5161453160a3" =
        [ ];
      "ActivityManager"."switch-to-activity-8fd45ddc-5096-4e4e-a343-612519d62ff3" =
        "Meta+0";
      "ActivityManager"."switch-to-activity-dbcface8-62ad-410c-89cd-556fbf93aceb" =
        "Meta+2";
      ...
      "kwin"."Window to Next Desktop" = "Meta+Ctrl+Shift+L";
      "kwin"."Window to Next Screen" = "Meta+Shift+Right";
      "kwin"."Window to Previous Desktop" = "Meta+Ctrl+Shift+H";
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."1a0b379e-262c-45b4-8b4e-5161453160a3" =
        "Default";
      "kactivitymanagerdrc"."activities"."8fd45ddc-5096-4e4e-a343-612519d62ff3" =
        "Scratch";
      "kactivitymanagerdrc"."activities"."dbcface8-62ad-410c-89cd-556fbf93aceb" =
        "Development";
      "kactivitymanagerdrc"."activities-icons"."8fd45ddc-5096-4e4e-a343-612519d62ff3" =
        "activities";
      "kactivitymanagerdrc"."activities-icons"."dbcface8-62ad-410c-89cd-556fbf93aceb" =
        "com.visualstudio.code.oss";
      "kactivitymanagerdrc"."main"."currentActivity" =
        "dbcface8-62ad-410c-89cd-556fbf93aceb";
      "kcminputrc"."Libinput/12815/20565/Telink CIDOO ABM066 Mouse"."ScrollFactor" =
        0.5;
      "kcminputrc"."Libinput/2821/6373/ASUSTeK ROG CHAKRAM"."PointerAcceleration" =
        "-0.600";
      "kcminputrc"."Libinput/2821/6373/ASUSTeK ROG CHAKRAM"."ScrollFactor" =
        1.5;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" =
        "{ffc63ddf-f15c-4cf8-8d14-2c1ba5d381b1}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" =
        "{71888ff0-cf6f-492f-a423-cc43debd03af}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" =
        "{c293d790-746c-4ae9-b44a-01dc039a3f93}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" =
        "{e601a523-9c01-424b-aeb1-944d5bf0053e}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" =
        "{497cfd45-eab3-4381-9ca9-32dfe133641f}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" =
        "{e6a3ae7c-4751-4381-8cde-90885aa22b07}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" =
        "{23e633e8-3ee3-4b34-8c05-2b659f68e83f}";
      ...
      "kscreenlockerrc"."Daemon"."LockGrace" = 180;
      "kscreenlockerrc"."Daemon"."Timeout" = 7;
      "kscreenlockerrc"."Greeter"."WallpaperPlugin" = "org.kde.potd";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.potd/General"."Category" =
        1339090;
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.potd/General"."FillMode" = 1;
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.potd/General"."Provider" =
        "unsplash";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "f6bc2880-8b10-4a81-8cb6-b2e91a4a7dc8";
      "kwinrc"."Desktops"."Id_2" = "017c9d4a-1b71-4ce1-8010-754192d3dcc9";
      "kwinrc"."Desktops"."Id_3" = "b6213e58-3404-4863-94d6-3f949e15e161";
      "kwinrc"."Desktops"."Number" = 3;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."EveningBeginFixed" = 1900;
      "kwinrc"."NightColor"."LatitudeFixed" = "-37.52";
      "kwinrc"."NightColor"."LongitudeFixed" = 144.76;
      ...
      "kwinrc"."Script-bismuth"."floatingClass" = "systemsettings";
      ...
      "kwinrc"."Tiling"."padding" = 9;
      "kwinrc"."Tiling/366d75db-25f3-537c-b891-000befcefe16"."tiles" = ''
        {"layoutDirection":"horizontal","tiles":x5b{"width":0.5013020833333319},{"layoutDirection":"vertical","tiles":x5b{"height":0.5},{"height":0.5}x5d,"width":0.4986979166666681}x5d}'';
      "kwinrc"."Tiling/ee63247d-d1e0-59ce-8b81-97e98d4a6881"."tiles" = ''
        {"layoutDirection":"horizontal","tiles":x5b{"width":0.4968750000000026},{"layoutDirection":"vertical","tiles":x5b{"height":0.5},{"height":0.5}x5d,"width":0.5031249999999974}x5d}'';
